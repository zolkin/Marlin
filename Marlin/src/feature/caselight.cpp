...
/**
 * The following are needed because ARM chips ignore a "WRITE(CASE_LIGHT_PIN,x)" command.  In order to
 * turn them off the brightness level needs to be set to off.  Since we can't use the pwm register to
