...
#define E_GEAR_DIAMETER   11.405 // Calibrated 2017-02-22 (200*8/(11.4*pi)) - 44.65
...
#define S_STEPS_PER_DEGREE (1.0 * NEMA_FULLSTEPS * S_MICROSTEPPING / 360.0)
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { STEPS_PER_DEGREE, STEPS_PER_DEGREE, Z_STEPS_PER_MM, E_STEPS_PER_MM, S_STEPS_PER_DEGREE }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT ((LEFT_PROBE_BED_POSITION + RIGHT_PROBE_BED_POSITION) / 2)    // X point for Z homing when homing all axis (G28).
  #define Z_SAFE_HOMING_Y_POINT ((FRONT_PROBE_BED_POSITION + BACK_PROBE_BED_POSITION) / 2)    // Y point for Z homing when homing all axis (G28).
#endif
