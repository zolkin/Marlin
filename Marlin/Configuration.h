...
#define CUSTOM_MACHINE_NAME "Kossel Linear+"
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS (DELTA_PRINTABLE_RADIUS*0.869) //64.0 // mm
  ...
  #define DELTA_TOWER_ANGLE_TRIM { -0.155, -0.663, 0.0 } // get these values from auto calibrate
...
#define MANUAL_Z_HOME_POS 292.53 // Distance between the nozzle to printbed after homing
