...
#define STRING_CONFIG_H_AUTHOR "Evgeny Mikerin" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anycubic Predator"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 414.57             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 227              // (mm) Get this value from G33 auto calibrate
...
#define DUET_SMART_EFFECTOR
  ...
  #define SMART_EFFECTOR_MOD_PIN  PA1//-1  // Connect a GPIO pin to the Smart Effector MOD pin
#endif
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0 } // was { 0, 0, -16 }
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   200 // Z Clearance for Deploy/Stow
...
#define HOMING_FEEDRATE_Z  (160*60)
